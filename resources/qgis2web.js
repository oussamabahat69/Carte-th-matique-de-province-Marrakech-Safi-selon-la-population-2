...
map.getView().fit([-1134192.148663, 3598444.116635, -740926.550766, 3877432.644499], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Carte du recensement 2024 de la population pour la région Marrakech-Safi (by BAHAT)</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (189 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Réalisation d\'une carte choroplèthe interactive basée sur la variation de la population entre les différentes provinces de la région de<br />Marrakech Safi selon le recensement du septembre 2024';
            }
