...
var style_Chef_Lieu_3 = function(feature, resolution){
    ...
    if ("" !== null) {
        ...
        image: new ol.style.Circle({radius: 3.69474 + size,
            stroke: new ol.style.Stroke({color: 'rgba(249,58,24,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 1.52}), fill: new ol.style.Fill({color: 'rgba(249,58,24,1.0)'})}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
